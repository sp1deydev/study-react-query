                ...
                <div className='home-container'>
                    ...
                    <Form form={form} component={false}>
                        <Table
                            ...
                            pagination={{  current: page, pageSize: LIMIT,  total: results[1].data }}
                    ...
                    >
                        <Form form={addNewProductForm} layout="vertical" autoComplete="off">
                            <Form.Item name="name" rules={[{ required: true, message: "Please input product name!" }]}> 
                            ...
                            <Form.Item>
                                <Button type="primary" htmlType="submit" style={{ width: '100%' }}>Add a new Product</Button>
                            </Form.Item>
                        </Form>
                    </Modal>
                </div>
